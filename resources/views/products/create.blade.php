        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Agregando un nuevo producto</h2>
                </div>
                <div class="card-body">
                    <form action="{{ url('/admin/lista-productos') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" id="product_name" name="product_name"
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="product_description" id="product_description"
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group mb-3">
                                    <input class="input--style-6" type="number" name="price" id="price" placeholder="Ingresa un precio valido y accesible">
                                  </div>
                            </div>
                        </div>
                        <div class="form-row">
